                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <input type="number" step="0.01" x-model="form.price" placeholder="0.00" class="w-24 border-b-2 border-slate-100 py-2 outline-none focus:border-<?= $color ?>-500 font-bold text-2xl bg-transparent transition-all placeholder:opacity-20">
                                <select x-model="form.currency" class="w-20 border-b-2 border-slate-100 py-2 outline-none focus:border-<?= $color ?>-500 font-bold text-xl bg-transparent transition-all cursor-pointer">
                                    <option value="EUR">€ (EUR)</option>
                                    <option value="USD">$ (USD)</option>
                                    <option value="GBP">£ (GBP)</option>
                                </select>
                                <div x-show="form.currency !== 'EUR'" class="flex items-center gap-2">
                                    <span class="text-slate-400 font-bold">≈</span>
                                    <input type="number" step="0.01" x-model="form.price_eur" placeholder="0.00" class="w-24 border-b-2 border-slate-100 py-2 outline-none focus:border-<?= $color ?>-500 font-bold text-2xl bg-transparent transition-all placeholder:opacity-20">
